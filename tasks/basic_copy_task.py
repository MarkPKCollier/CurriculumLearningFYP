...
parser.add_argument('--init_mode', type=str, default='random', help='random | zero | learned -> only necessary for ntm')
    ...
    def _build_model(self):
        if args.mann == 'none':
            ...
            cell = NTMCell(args.controller_type, args.num_layers, args.num_units, args.num_memory_locations, args.memory_size,
                ...
                reuse=False, output_dim=args.num_bits_per_vector, clip_value=args.clip_value)
