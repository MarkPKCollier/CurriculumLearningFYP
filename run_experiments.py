...
--region=us-central1 \
--job-dir=gs://pcollier2001/{0}_mann_{1}_curric_{2}_pad_{3}_num_{6}_{7} \
--runtime-version=1.6 \
...
VERSION = 7
NUM_EXPERIMENTAL_REPEATS = 1

# task, max_seq_len, max_repeats, num_bits_per_vector, num_memory_locations, memory_size, num_read_heads, learning_rate, batch_size, eval_batch_size, num_train_steps, steps_per_eval = ('copy', 20, -1, 8, 128, 20, 1, 0.001, 32, 640, 15625, 200)
task, max_seq_len, max_repeats, num_bits_per_vector, num_memory_locations, memory_size, num_read_heads, learning_rate, batch_size, eval_batch_size, num_train_steps, steps_per_eval = ('repeat_copy', 10, 10, 8, 128, 20, 1, 0.001, 32, 640, 15625, 200)
# task, max_seq_len, max_repeats, num_bits_per_vector, num_memory_locations, memory_size, num_read_heads, learning_rate, batch_size, eval_batch_size, num_train_steps, steps_per_eval = ('associative_recall', 6, -1, 6, 128, 20, 1, 0.001, 32, 640, 15625, 200)
